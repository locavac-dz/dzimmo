...
const AR = {
  ...
  // Mise à la une (server/routes/promotions.js, PUT /api/admin/properties/:id/une)
  'Les mises à la une ne sont pas ouvertes pour le moment.': 'خدمة إبراز الإعلانات غير متاحة حالياً.',
  'Formule invalide.': 'العرض غير صالح.',
  'Seule une annonce publiée peut être mise à la une.': 'لا يمكن إبراز إلا إعلان منشور.',
  'Paiement introuvable.': 'عملية الدفع غير موجودة.',
  "Ce paiement n'est plus en attente.": 'لم تعد عملية الدفع هذه قيد الانتظار.',
  "Le paiement en ligne n'est pas disponible.": 'الدفع عبر الإنترنت غير متاح.',
  'Paiement en ligne non raccordé (SATIM).': 'الدفع عبر الإنترنت غير مرتبط بعد (SATIM).',
  'Durée invalide.': 'المدة غير صالحة.',
