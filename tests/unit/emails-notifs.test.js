...
const SAMPLES = {
  ...
  buildContactRequest:     { ownerName: 'Karim', requesterName: 'Sara', propertyTitle: 'Villa X', type: 'offre', message: 'Hello', visitDate: '2026-10-01', visitTime: '10:00', offerAmount: 25000000 },
  buildVisitReminder:      { recipientName: 'Karim', requesterName: 'Sara', ownerName: 'Karim', propertyTitle: 'Villa X', visitDate: '2026-10-01', visitTime: '10:00', propertyUrl: 'https://dzimmo.dz/annonce/1', role: 'owner' },
  ...
  buildWeeklyDigest:              { name: 'Karim', properties: [{ id: 1, title: 'Villa X', views_7d: 42 }], totals: { views_7d: 120, contacts_7d: 3, fav_7d: 5, active_count: 2 } },
  buildMonthlyReport:             { month: 'août 2026', new_users: 42, new_listings: 120, sold_rented: 15, reports_closed: 8, featured_revenue: 45000, total_views: 25000 },
};
